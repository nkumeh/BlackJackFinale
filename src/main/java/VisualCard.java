...
public class VisualCard {
     ...
     */
    private void setUnicodeSuit(Suit suit) {
     ...
     */
    private void setCardValue(Name name) {
        if (isFaceCard(name)) {
     ...
     */
    private String formatSuit(int row) throws IllegalArgumentException {
     ...
     */
    private String formatCardValue() {
